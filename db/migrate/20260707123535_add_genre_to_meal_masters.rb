class AddGenreToMealMasters < ActiveRecord::Migration[7.2]
  ...
  WESTERN_KEYWORDS  = /トースト|食パン|スパゲッティ|パスタ|ソテー|ムニエル|グリル|クリーム|チーズ|タンドリー|ロースト|マリネ|ピクルス|カプレーゼ|コールスロー|ポテト|ラペ|ズッキーニ|コンソメ|ハニーマスタード|ベーコン|ウインナー|ハヤシ|ナポリタン|ペペロンチーノ|オムライス|カレー|ガーリック|スクランブル|トマトソース|トマト煮/
