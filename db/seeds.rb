...
create_meal_masters(
  {
    ...
    "ハヤシライス(350g)" => 600,
    "麻婆豆腐丼(350g)" => 580,
    "ツナとキャベツのトマトソースオートミール(200g)" => 270,
    "キャベツのお好み焼き(200g)" => 400,
    "ビビンバ(350g)" => 580,
    "しらすと青じそのスパゲッティ(250g)" => 480,
    "いわし缶の和風スパゲッティ(300g)" => 550,
    "たらことえのきのパスタ(300g)" => 520,
    "オートミールオムライス(250g)" => 320,
    "オートミール中華粥(300g)" => 220,
    "オートミールと鶏胸肉の中華粥(300g)" => 250
...
link_meal_allergens(
  {
    ...
    "ハヤシライス(350g)" => [ "牛肉" ],
    "麻婆豆腐丼(350g)" => [ "大豆" ],
    "キャベツのお好み焼き(200g)" => %w[小麦 卵],
    "ビビンバ(350g)" => [ "卵" ],
    "しらすと青じそのスパゲッティ(250g)" => [ "小麦" ],
    "いわし缶の和風スパゲッティ(300g)" => [ "小麦" ],
    "たらことえのきのパスタ(300g)" => [ "小麦" ],
    "オートミールオムライス(250g)" => [ "卵" ],
    "オートミールの枝豆とチーズの塩昆布おにぎり1個" => %w[乳 大豆],
    "オートミールと鶏胸肉の中華粥(300g)" => [ "鶏肉" ]
  }
)
